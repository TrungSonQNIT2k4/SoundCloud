...
// Kiểm tra xem ID của bài hát đã được gửi đến và có giá trị hợp lệ hay không
if(isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo '<script>';
        echo 'alert("Bạn đã xóa bài hát thành công");';
        echo 'window.location.href = "ad.php#songs";';
        echo '</script>';
    } else {
        // Hiển thị thông báo nếu có lỗi khi xóa
        echo '<script>';
        echo 'alert("Xóa bài hát không thành công");';
        echo '</script>';
    }
