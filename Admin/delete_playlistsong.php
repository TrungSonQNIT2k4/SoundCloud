...
// Kiểm tra xem ID của playlistsong đã được gửi đến và có giá trị hợp lệ hay không
if(isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM playlistsongs WHERE id = ?");
