...
// Kiểm tra xem ID của playlist đã được gửi đến và có giá trị hợp lệ hay không
if(isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($stmt->execute()) {
        ...
        echo '<script>';
        echo 'alert("Bạn đã xóa playlist thành công");';
        echo 'window.location.href = "ad.php#playlists";';
        echo '</script>';
    } else {
        // Hiển thị thông báo nếu có lỗi khi xóa
        echo '<script>';
        echo 'alert("Xóa playlist không thành công");';
        echo '</script>';
    }
