...
$bannerPath = isset($_POST['bannerPath']) ? $_POST['bannerPath'] : '';
$country = isset($_POST['country']) ? $_POST['country'] : '';
$message = ''; // Biến để lưu thông báo

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $sql = "INSERT INTO banners (title, artist, genre, bannerPath, Country) VALUES ('$title', '$artist', '$genre', '$bannerPath', '$country')";
    ...
    <script>
        window.onload = function() {
            ...
            if (message) {
                ...
                window.location.href = "ad.php#banners"; // Chuyển hướng người dùng đến trang ad.php
            }
        }
    </script>
</head>
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <input type="text" id="bannerPath" name="bannerPath" value="<?php echo $bannerPath; ?>" required>
