...
function createPlaylist() {
	...
	var popup = prompt("Nhập tên bạn muốn tạo cho Playlist vào ô dưới đây");
	if(popup != null) {
...
function deletePlaylist(playlistId) {
	...
	var prompt = confirm("Bạn có chắc khi muốn xoá Playlist này?");
	if(prompt) {
...
// Lấy tất cả các mục trên thanh navbar
var navItems = document.querySelectorAll('.navItemLink');

// Lặp qua tất cả các mục và thêm sự kiện 'click'
